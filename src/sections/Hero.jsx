  ...
  return (
    <section className="hero-section" id="hero">
      <div className="hero-left">
        ...
        <div className="hero-bottom">
          ...
          <div className="social-icons">
            <a
              href="https://www.linkedin.com/in/Venkatesh-Github"
              target="_blank"
            ...
            <a
              href="https://github.com/Venkatesh-Github"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaGithub />
            ...
            <a
              href="https://leetcode.com/u/Venkatesh_Github/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <SiLeetcode />
            ...
            <a
              href="https://medium.com/@VenkateshGithub"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaMedium />
      ...
      <div className="hero-right">
        <img src={VenkateshImage} alt="Venkatesh Github" />
      </div>
    </section>
  );
}
